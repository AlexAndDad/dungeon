...
struct Monster
{
    ...
    struct ImplementationConcept
    {
        ...
        virtual bool
        invoke_hates(Monster const &other) const = 0;
...
private:
    ...
    template<class ActualMonster>
        struct ImplementationModel final : ImplementationConcept
        {
            ...
            bool
            invoke_hates(Monster const &other) const override
            {
...
public:
    ...
    auto as_concept() -> ImplementationConcept &
    {
        return *impl_;
    }


    auto as_concept() const -> ImplementationConcept const &
    {
        return *impl_;
    }


    auto hates(Monster const &other) const -> bool
    {
